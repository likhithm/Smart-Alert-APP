...
public class FirebaseMessageService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            Message_Body = remoteMessage.getData().toString();

            String click_action = "com.life.smart.smartalert.SmartAlertActivities_TARGET_NOTIFICATION";
                                  //remoteMessage.getNotification().getClickAction();

            date = Calendar.getInstance().getTime();
            date_time_string = date.toString();
            //Calling method to generate notification
            sendNotification(Message_Body,date_time_string,  click_action);
     ...
     */
     /*private void sendRegistrationToServer(String token) {
        ...
        // send to google cloud via http post!!
        Log.d(TAG, "Make HTTP Post!!!!: " + token);
    }*/
    ...
    public void sendRegistrationToServer(final String token){
        ...
        userReportFunctionClass.execute(token);
    }

    @Override
    public void onDeletedMessages() {

        //This occurs when there are too many messages (>100) pending for your app on a
        // particular device at the time it connects or if the device hasn't connected to FCM in more than one month.
     ...
     */
    private void sendNotification(String messageBody, String date, String click_action) {
        Log.d(TAG, "Message data payload: " + messageBody +"in sendnotification begin!!");
        ...
        Log.d(TAG, "Message data payload: " + messageBody +"in sendnotification end!!");
