...
/*
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.listnotifications);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        date = (TextView) findViewById(R.id.notification_date);

        Intent intent_o = getIntent();
        String noti_message = intent_o.getStringExtra("message");
        String noti_date = intent_o.getStringExtra("date");

        message.setText(noti_message);
        date.setText(noti_date);
